...
namespace Planetario_PI_IS_BD.Tests.PrepararPruebas
{
  public class PaginaTienda{
    ...
    public IWebElement CompararOrdenamiento(String comparacion){
      ...
      WebDriverWait esperar = new WebDriverWait(DriverChrome, TimeSpan.FromTicks(100000000000000000));
      esperar.Until(ExpectedConditions.VisibilityOfAllElementsLocatedBy(seleccion));
