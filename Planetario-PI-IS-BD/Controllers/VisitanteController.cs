...
namespace Planetario.Controllers {
  ...
  public class VisitanteController : Controller {
    ...
    [HttpPost]
    public ActionResult InscribirVisitante(VisitanteModel visitante, int cuposComprados = 0, String tipoInscripcion = "actividad") {
    ...
    [HttpPost]
    public ActionResult VerificarInscripcionEnPlanetario(VisitanteModel visitante, int cuposComprados, String tipoInscripcion = "") {
      ActividadModel actividad = new ActividadModel();
      if (tipoInscripcion == "actividad") {
        actividad = AccesoDatosActividad.ObtenerActividad(visitante.TituloActividadInscrita, visitante.FechaActividadInscrita);
        ViewBag.Actividad = actividad;
