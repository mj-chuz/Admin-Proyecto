...
namespace Planetario.Handlers {
  public class BaseDeDatosHandler {
    protected SqlConnection ConexionPlanetario;
    ...
    public DataTable CrearTablaConsulta(SqlCommand comandoParaConsulta) {      
      ...
      bool switchear = conexionSQL.State == ConnectionState.Closed;
      if(switchear) conexionSQL.Open();
      adaptadorParaTabla.Fill(consultaFormatoTabla);
      if(switchear) conexionSQL.Close();
