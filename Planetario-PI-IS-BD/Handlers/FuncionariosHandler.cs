...
namespace Planetario.Handlers {
  public class FuncionariosHandler : BaseDeDatosHandler {
    ...
    public bool CrearFuncionario(FuncionarioModel funcionario) {
      ...
      SqlTransaction transaccion = ConexionPlanetario.BeginTransaction();
      bool exitoAlcrear = true;
      try { 
        InsertarFotoFuncionario(funcionario,transaccion);
        CrearComandoInsercionFuncionario(funcionario, transaccion);
        AgregarIdiomasFuncionario(funcionario, transaccion);
        transaccion.Commit();
    ...
    public bool ModificarFuncionario(FuncionarioModel funcionario) {
      ...
      LlenarDatosFotoFuncionario(consultaFoto, funcionario);
    ...
    public bool InsertarFotoFuncionario(FuncionarioModel funcionario, SqlTransaction transaccion = null) {
      string consultaFoto = " INSERT INTO Imagen (nombrePK, extension, archivo) "
  + " VALUES (@nombrePK, @extension, @archivo) ";
      bool exitoInsertarFoto = LlenarDatosFotoFuncionario(consultaFoto, funcionario, transaccion);
      return exitoInsertarFoto;
    }

    public bool CrearComandoInsercionFuncionario(FuncionarioModel funcionario, SqlTransaction transaccion) {
      ...
      bool exitoInsertarFuncionario = InsertarDatosFuncionario(consulta, funcionario, transaccion);
      return exitoInsertarFuncionario;
    }

    public bool LlenarDatosFotoFuncionario(string consulta, FuncionarioModel funcionario, SqlTransaction transaccion = null) {
      string nombreFoto = "foto" + funcionario.NumeroIdentificacion;
      SqlCommand comandoParaConsultaFoto;
      if (transaccion == null) {
        comandoParaConsultaFoto = new SqlCommand(consulta, ConexionPlanetario);
      } else {
        comandoParaConsultaFoto = new SqlCommand(consulta, ConexionPlanetario, transaccion);
      }
      string[] partesDeFoto = funcionario.archivoFoto.ContentType.Split('/');
      string extensionDeFoto = "." + partesDeFoto[1];
    ...
    public bool InsertarDatosFuncionario(string consulta, FuncionarioModel funcionario, SqlTransaction transaccion = null) {
    ...
    public bool AgregarIdiomasFuncionario(FuncionarioModel funcionario, SqlTransaction transaccion = null) {
