...
async function obtenerProductos2(categoria, columnaOrdenamiento, direccionOrdenamiento, busqueda) {
    ...
    if (document.getElementById("campo-busqueda").value != null)
        document.getElementById("campo-busqueda").value = busquedaActual
    actualizarCategoria();
    await $.ajax({
        type: 'POST',
    ...
    await $.ajax({
        ...
        data: { categoria: categoria, columnaOrdenamiento: columnaOrdenamiento, direccionOrdenamiento: direccionOrdenamiento, pagina: paginaActual, busqueda: busqueda },
...
function actualizarOpcionesPaginas() {
    ...
    $("#pagina-primera-opcion").click(function () { paginaActual = $("#pagina-primera-opcion").attr("value"); obtenerProductos2(categoriaActual, columnaOrdenamientoActual, ordenamientoActual, busquedaActual) });
    $("#pagina-segunda-opcion").click(function () { paginaActual = $("#pagina-segunda-opcion").attr("value"); obtenerProductos2(categoriaActual, columnaOrdenamientoActual, ordenamientoActual, busquedaActual) });
    $("#pagina-tercera-opcion").click(function () { paginaActual = $("#pagina-tercera-opcion").attr("value"); obtenerProductos2(categoriaActual, columnaOrdenamientoActual, ordenamientoActual, busquedaActual ) });
}
